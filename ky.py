...
from kivymd.uix.popup import Popup
from kivymd.uix.boxlayout import BoxLayout
from kivymd.uix.image import Image
'''
class SRMAlexaApp(App):
    def build(self):
        ...
        main_layout.add_widget(Image(source='D:/1. Dharal/Desktop/GitHub Programs/srmalexabot/Capture.PNG'))  # Add SRM Alexa logo
